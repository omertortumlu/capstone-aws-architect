...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.chmonysaxp4b.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesrayblog' # please enter your s3 bucket name
